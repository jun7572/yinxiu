...
class _BorderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // var pathP = _initRoundPath(size.width, size.height, 1);

    // canvas.drawPath(pathP, p2);
    canvas.drawRRect(RRect.fromLTRBR(0, 0, size.width, size.height, Radius.circular(50)), p2);

    // canvas.drawCircle(Offset.zero, 10, p2);
